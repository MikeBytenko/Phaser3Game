class gameplay3M extends Phaser.Scene {
  constructor() {
    super("gameplay3M");
  }
  init(data) {
  ...
  create() {
    ...
    this.expMask = this.add
      .sprite(this.aGrid.placeAtIndexX(4.44), expBar3.y, "expBar")
      .setScale(1.3);

    this.expMask.visible = false;

    expBar3.mask = new Phaser.Display.Masks.BitmapMask(this, this.expMask);
    ...
    this.input.once("pointerdown", () => {
      ...
      button.once("pointerdown", () =>
        this.scene.start(
          this.ImageID.indexOf("dress1") !== -1 ? "winM" : "wastedM",
          {
            id: this.ImageID,
